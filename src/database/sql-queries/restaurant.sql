CREATE DATABASE
    IF NOT EXISTS `kata_sql_restaurant`
...
INSERT INTO `menu`
VALUES (1, 'Le menu cher', 1), (2, 'Le menu très cher', 1), (3, 'Le menu trop cher', 1), (4, 'Le menu unique', 2), (5, 'Pastèque et camembert', 3), (6, 'Picouli', 3), (7, 'Menu midi', 4), (8, 'Menu soir', 4), (9, 'Brunch de ouf', 5), (10, 'Les petits plats', 6), (11, 'Menu enfant', 6), (12, 'Menu A', 7), (13, 'Menu B', 7), (14, 'Menu C', 7), (15, 'Menu S+', 7), (16, 'Mangeons bien', 8), (17, 'Mangeons équilibré', 8), (18, 'Mangeons peu', 8), (19, 'Mangeons beaucoup', 8), (20, 'Faim de table', 10);
...
VALUES (1, 1), (10, 1), (2, 2), (2, 3), (6, 3), (12, 3), (7, 4), (18, 4), (1, 5), (4, 5), (7, 5), (16, 5), (3, 6), (8, 7), (16, 7), (19, 8), (20, 8), (7, 9), (9, 10), (15, 10), (3, 12), (7, 12), (8, 13), (14, 13), (7, 15), (18, 15), (2, 16), (3, 16), (4, 16), (11, 16), (12, 16), (1, 17), (4, 18), (15, 18), (6, 19), (8, 19), (8, 20), (9, 20), (10, 20), (11, 20);
...
VALUES (1, 'Guy Savoy', 'Paris'), (2, 'Alain Ducasse', 'Paris'), (
        3,
        'La Vague d’Or',
        'Saint Tropez'
    ), (4, 'L’Ambroisie', 'Paris'), (
        ...
        'Tinqueux'
    ), (7, 'L’Arpège', 'Paris'), (8, 'Pavillon Ledoyen', 'Paris'), (9, 'Le Pré Catelan', 'Paris'), (
        10,
        'La Maison Troisgros',
        'Ouches'
    );
...
SELECT DISTINCT name FROM dish RIGHT JOIN ON dish.id=menu.dish_id;
...
FROM menu_dish
    INNER JOIN dish ON dish_id = dish.id
    INNER JOIN menu ON menu_id = menu.id FULL OUTER
    JOIN restaurant ON menu.restaurant_id = restaurant.id;

SELECT
    title as The_menu,
    name as The_Restaurant
FROM menu
    RIGHT JOIN restaurant ON menu.restaurant_id = restaurant.id
HAVING
    name IS NOT NULL
...
FROM menu_dish
    ...
    SELECT
    title,
    COUNT(dish_id) AS count_dishes
FROM menu_dish 
HAVING count_dishes IN (SELECT MAX (dish_id) FROM menu_dish)
INNER JOIN menu ON menu_id = menu.id;